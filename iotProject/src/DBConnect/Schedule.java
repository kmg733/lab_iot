...
public class Schedule {	//	일정 등록
	...
	public String scheduleAdd(String title, String text, String date) {	//	일정 등록
			try {
				...
				// TODO Auto-generated catch block
				System.err.println("Schedule scheduleAdd SQLException error");
				returns = "error";
			} finally {
				if (pstmt != null)
					try {
	...
	public String scheduleShow( String title, String date) {	//	제목에 해당하는 일정 상세히 보기
			try {
				...
				// TODO Auto-generated catch block
				System.err.println("Schedule scheduleShow SQLException error");
				returns = "error";
			} finally {
				if (pstmt != null)
					try {
	...
	public String scheduleDelete(String title, String date) {	//	일정 삭제
			try {
				...
				// TODO Auto-generated catch block
				System.err.println("Schedule scheduleDelete SQLException error");
				returns = "error";
			} finally {
				if (pstmt != null)
					try {
	...
	public String scheduleModify(String beforeTitle, String afterTitle, String afterText, String date) {	//	일정 수정
			try {
				...
				// TODO Auto-generated catch block
				System.err.println("Schedule scheduleModify SQLException error");
				returns = "error";
			} finally {
				if (pstmt != null)
					try {
